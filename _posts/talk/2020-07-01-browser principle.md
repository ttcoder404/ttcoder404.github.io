...
![进程1](/images/posts/browser/1.png)
...
![进程关系](/images/posts/browser/2.png)
...
![进程关系](/images/posts/browser/3.png)
...
![浏览器容错性](/images/posts/browser/4.png)
...
![开始导航](/images/posts/browser/7.png)
...
![查找渲染进程](/images/posts/browser/8.png)
...
![提交导航](/images/posts/browser/9.png)
...
![浏览器进程中线程](/images/posts/browser/10.png)
...
![加载子资源](/images/posts/browser/11.png)
...
![样式计算](/images/posts/browser/12.png)
...
![layout](/images/posts/browser/13.png)
...
![paint](/images/posts/browser/14.png)
...
![最简单的光栅化过程](/images/posts/browser/15.gif)
...
![合成的光栅化过程](/images/posts/browser/16.gif)
...
![layer tree](/images/posts/browser/17.png)
...
![光栅线程创建图块的位图并发送给GPU](/images/posts/browser/18.png)
...
![合成线程构建出合成帧，合成帧会被发送给浏览器进程然后再发送给GPU](/images/posts/browser/19.png)
...
![点击事件从浏览器进程路由到渲染进程](/images/posts/browser/20.png)
...
![非快速滚动区域有用户事件发生](/images/posts/browser/21.png)
...
![当整个页面都是非快速滚动区域时页面的事件处理示意图](/images/posts/browser/22.png)
...
![当整个页面都是非快速滚动区域时页面的事件处理示意图](/images/posts/browser/23.png)
...
![事件淹没了屏幕刷新的时间轴，导致页面很卡顿](/images/posts/browser/24.png)

出于优化的目的，浏览器会合并这些连续的事件，延迟到下一帧渲染是执行，也就是`requestAnimationFrame`之前。

![和之前相同的事件轴，可是这次事件被合并并延迟调度了](/images/posts/browser/25.png)
